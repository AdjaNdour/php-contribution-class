    ...
    <main class="flex-1 overflow-y-auto p-6 space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-surface rounded-xl border border-gray-100 p-4">
          ...
          <p class="text-[11px] font-semibold tracking-wide text-text-muted">TOTAL COTISE</p>
          <p class="font-display font-semibold text-xl text-text mt-1">43 000 Fcfa</p>
        </div>
        <div class="bg-surface rounded-xl border border-gray-100 p-4">
        ...
        <table class="w-full text-sm">
          <tbody class="divide-y divide-gray-100">
            <tr class="hover:bg-background/60">
              ...
              <td class="px-5 py-4 text-text-muted text-right">10 / 52</td>
            </tr>
            <tr class="hover:bg-background/60">
              <td class="px-5 py-4">
                <div class="flex items-center gap-2.5">
              ...
              <td class="px-5 py-4 text-text-muted text-right">23 / 52</td>
            </tr>
            <tr class="hover:bg-background/60">
              <td class="px-5 py-4">
                <div class="flex items-center gap-2.5">
              ...
              <td class="px-5 py-4 text-text-muted text-right">49 / 52</td>
            </tr>
            <tr class="hover:bg-background/60">
              <td class="px-5 py-4">
                <div class="flex items-center gap-2.5">
              ...
              <td class="px-5 py-4 text-text-muted">12000 FCFA</td>
              <td class="px-5 py-4 text-text-muted text-right">51 / 52</td>
            </tr>
          </tbody>
        </table>
      </div>
